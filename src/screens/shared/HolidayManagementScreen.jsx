...
const HolidayManagementScreen = ({navigation}) => (
      ...
      <Animated.View entering={FadeInDown.delay(60).duration(380).springify()} style={styles.illustrationCard}>
        <View style={styles.iconRing}>
          <View style={styles.iconInner}>
            <MaterialCommunityIcons name="calendar-remove-outline" size={52} color={colors.danger} />
          </View>
        </View>
        ...
        <Text style={styles.featureTitle}>Holiday Management</Text>
        <Text style={styles.featureDesc}>
          Manage school holidays, public holidays, and festival calendars
          for your branch — all in one place.
        </Text>
        ...
        <View style={styles.featureList}>
          {[
            {icon: 'flag-outline',         label: 'National & public holidays'},
            {icon: 'star-circle-outline',  label: 'Festival & school holidays'},
            {icon: 'calendar-edit',        label: 'Add, edit & delete entries'},
            {icon: 'calendar-sync-outline',label: 'Academic year–bound calendar'},
          ].map(f => (
