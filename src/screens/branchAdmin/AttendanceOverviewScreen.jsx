...
const AttendanceOverviewScreen = () => {
  ...
  const minDate = activeAcademicYear?.startDate || null;
  ...
  const classesQuery = useQuery({
    queryKey: ['overviewClasses', user?.branchId],
  ...
  const sectionsQuery = useQuery({
    queryKey: ['overviewSections', selectedClass?.id],
  ...
  const attendanceQuery = useQuery({
    queryKey: ['overviewAttendance', selectedSection?.id, selectedDate],
    ...
    <FlatList
      ...
      ListHeaderComponent={
        <Animated.View entering={FadeInDown.duration(280).springify()} style={styles.heroCard}>
          ...
          <Text style={styles.heroOverline}>Branch Admin</Text>
      ...
      renderItem={({item, index}) => (
        <Animated.View entering={FadeInRight.delay(index * 35).duration(230).springify()}>
          <Pressable
            ...
            <View style={[styles.selIcon, {backgroundColor: `${colors.purple}15`}]}>
              <MaterialCommunityIcons name="google-classroom" size={20} color={colors.purple} />
            </View>
      ...
      ListHeaderComponent={
        <View>
          ...
          <Animated.View entering={FadeInDown.duration(280).springify()} style={styles.heroCard}>
            ...
            <Text style={styles.heroSub}>Branch-wide attendance submissions</Text>
          </Animated.View>
          ...
          <Animated.View
            ...
            <Pressable
              ...
              <MaterialCommunityIcons
                name="chevron-left"
                size={22}
                color={atMinDate ? colors.border : colors.purple}
              />
            </Pressable>
            ...
            <Pressable
              ...
              <MaterialCommunityIcons
                name="chevron-right"
                size={22}
                color={atMaxDate ? colors.border : colors.purple}
              />
            </Pressable>
          </Animated.View>
...
const styles = StyleSheet.create({
  ...
  todayChip:     {color: colors.purple, fontSize: 10, fontWeight: '700'},
